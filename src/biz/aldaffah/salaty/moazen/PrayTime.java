package biz.aldaffah.salaty.moazen;
...
import biz.aldaffah.salaty.ui.Settings;
...
public class PrayTime {
  ...
  // ------------------------------------------------------------
  // Calculation Methods
  // Are public in order to set them in Manager.java
  ...
  //I have changed visibility from private to public --Nazim
